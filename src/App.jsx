...
const overdueDetail = allPOs.filter(p => insightsAll.pastDue.includes(p))
  .map(p => {
    ...
    const minETA = etas[0];
    const daysLate = Math.floor((new Date("2026-07-03") - new Date(minETA)) / 86400000);
